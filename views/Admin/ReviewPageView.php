...
?>
        <div class="container">
            <div id="filter">
                ...
                <div>
                    <select class="form-control bootstrap-table-filter-control-user">
                        <option value="">Username</option>
                    </select>
                    <select class="form-control bootstrap-table-filter-control-vehicule">
            ...
            <thead>
                ...
                <th data-field="version"data-sortable="true">Comment</th>
