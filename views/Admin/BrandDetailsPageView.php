...
class AdminBrandDetailsPageView extends LayoutView
{
            ...
            <div class="table-responsive">
                <table id="table" class="table table-striped table-bordered table-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $vehicles = $controller->getVehiculeByID($id);
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $vehicle['Dimensions'] ?></td>
                                ...
                                <td>
                                    <div class="manage">
                                        <a href="/Project/Admin/brand/details/?id=<?php echo $vehicle['VehicleID'] ?>">
